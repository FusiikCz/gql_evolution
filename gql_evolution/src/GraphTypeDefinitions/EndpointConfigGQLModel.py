...
class EndpointConfigGQLModel(BaseGQLModel):
    ...
    model_mapping: typing.Optional[JSON] = strawberry.field(
        default=None,
...
class EndpointConfigMutation:
    @strawberry.mutation(
        ...
        permission_classes=[
            OnlyForAuthentized,
            SimpleInsertPermission[EndpointConfigGQLModel](roles=["administrátor", "api_key_administrator"])
        ]
    )
    ...
    @strawberry.mutation(
        ...
        permission_classes=[
            OnlyForAuthentized,
            SimpleUpdatePermission[EndpointConfigGQLModel](roles=["administrátor", "api_key_administrator"])
        ]
    )
    ...
    @strawberry.mutation(
        ...
        permission_classes=[
            OnlyForAuthentized,
            SimpleDeletePermission[EndpointConfigGQLModel](roles=["administrátor", "api_key_administrator"])
        ]
    )
