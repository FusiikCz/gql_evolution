...
from .EventInvitationStateGQLModel import EventInvitationStateMutation
...
class Mutation(EventMutation, EventInvitationMutation, EventInvitationStateMutation, ApiKeyMutation, UsageMutation, DocumentMutation, DocumentFragmentMutation, UserMutation, EndpointConfigMutation):
    pass
